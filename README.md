...
Tenemos que crear este kind.yaml
...
kubectl hlf ca create --image=$CA_IMAGE --version=$CA_VERSION --storage-class=standard --capacity=1Gi --name=org1-ca --namespace=nft \
...
5. Obtener la cadena de conexion sin usuarios para la organizacion MarketplaceMSP y OrdererMSP
